...
public class RecordToxVal {
	...
	public String ID;
	public String casrn;//from chemical table
	public String name;//from chemical table
		...
		public String toxval_type_supercategory;//from toxval_type_dictionary
		...
		public transient static String[] varlist = { "dtxsid", "toxval_id", "source", "subsource", "toxval_type",
				...
				"species_original", "species_common", "species_scientific","species_supercategory", "habitat", "human_eco", "strain",
				...
				"exposure_form_original", "media", "media_original", "critical_effect", "quality_id",
